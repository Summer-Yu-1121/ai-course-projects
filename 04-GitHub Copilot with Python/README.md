...
A dedicated instruction file, `COPILOT_INSTRUCTIONS.md`, is included in the project root
to guide Copilot's behavior, coding style, and design decisions.

Copilot was used to:
- Refactor legacy Flask and Python code into a modular, maintainable structure
- Set up the testing framework
- Design and validate Sudoku logic (including enforcing a single unique solution)
- Implement features such as difficulty levels, hints, timer, and leaderboard
- Assist with UI styling decisions (e.g., 3x3 grid coloring and dark mode)

All major Copilot interactions are documented with screenshots.

## Testing

This project uses `pytest` for testing core Sudoku logic.

Before refactoring, an initial test suite was created to establish a baseline for the
